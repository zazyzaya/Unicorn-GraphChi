...
run_vgame_v2:
	...
	number=203 ; while [ $$number -le 299 ] ; do \
...
run_download_v2:
	...
	number=405 ; while [ $$number -le 499 ] ; do \
...
run_cnn_v2:
	...
	number=506 ; while [ $$number -le 599 ] ; do \
