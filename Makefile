...
run_toy:
	...
	number=0 ; while [ $$number -le 99 ] ; do \
		bin/streaming/main filetype edgelist file ../../data/toy_data/base_train/base-toy-$$number.txt niters 10000 stream_file ../../data/toy_data/stream_train/stream-toy-$$number.txt decay 500 lambda 0.0 window 500 interval 2000 multiple 1 sketch_file ../../data/train_toy/sketch-toy-$$number.txt chunkify 0 chunk_size 50 ; \
	...
	number=300 ; while [ $$number -le 399 ] ; do \
		bin/streaming/main filetype edgelist file ../../data/toy_data/base_test/base-attack-$$number.txt niters 10000 stream_file ../../data/toy_data/stream_test/stream-attack-$$number.txt decay 500 lambda 0.0 window 500 interval 2000 multiple 1 sketch_file ../../data/test_toy/sketch-attack-$$number.txt chunkify 0 chunk_size 50 ; \
...
cadets_e3:
	...
	number=0 ; while [ $$number -le 7 ] ; do \
		bin/streaming/main filetype edgelist file ../../data/cadets-e3/train/base/base-cadets-e3-benign-$$number.txt niters 100000 stream_file ../../data/cadets-e3/train/stream/stream-cadets-e3-benign-$$number.txt decay 500 lambda 0.02 window 500 interval 5000 multiple 1 sketch_file ../../data/cadets-e3/train_sketch/sketch-benign-$$number.txt chunkify 1 chunk_size 5 ; \
	...
	number=0 ; while [ $$number -le 0 ] ; do \
		bin/streaming/main filetype edgelist file ../../data/cadets-e3/test/base/base-cadets-e3-attack-$$number.txt niters 100000 stream_file ../../data/cadets-e3/test/stream/stream-cadets-e3-attack-$$number.txt decay 500 lambda 0.02 window 500 interval 5000 multiple 1 sketch_file ../../data/cadets-e3/test_sketch/sketch-attack-$$number.txt chunkify 1 chunk_size 5 ; \
